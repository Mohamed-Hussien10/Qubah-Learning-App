...
class LessonsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (_) => sl<LessonsCubit>()..loadLessons(unitId),
...
class _LessonsView extends StatelessWidget {
          ...
          children: [
            ...
            BlocBuilder<LessonsCubit, LessonsState>(
              builder: (context, state) {
                final unitName = state is LessonsLoaded ? state.unitName : '';
  ...
  Widget _buildBreadcrumb(BuildContext context, bool isDark, String unitName) {
    return Row(
      children: [
        InkWell(
          onTap: () => context.pop(),
  ...
  Widget _buildHeader(BuildContext context, bool isDark) {
    return Row(
      children: [
        Icon(Icons.play_lesson_rounded, color: AppColors.primary, size: 28),
                          ...
                          CircleAvatar(
                            ...
                            backgroundImage:
                                (lesson.thumbnailUrl != null &&
                                    ...
                                    ? NetworkImage(
                                      resolveImageUrl(lesson.thumbnailUrl!),
                                    )
                                    : null,
                      ...
                      Row(
                        ...
                        children: [
                          _ActionIcon(
                            ...
                            onTap: () => _showForm(context, lesson: lesson),
                          ),
                          _ActionIcon(
                            icon: Icons.delete_outline_rounded,
                            tooltip: AppStrings.delete,
                            color: AppColors.error,
                            onTap: () => _confirmDelete(context, lesson),
                          ),
                        ],
                      ),
                    ),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          FilledButton.icon(
            onPressed: () => context.read<LessonsCubit>().loadLessons(unitId),
  ...
  void _navigateToFiles(BuildContext context, LessonModel lesson) {
    context.push('/lesson-files/${lesson.id}');
  }
}
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(
                      _isEditing ? 'تعديل الدرس' : 'إضافة درس جديد',
